    ...
    return (
        <div className={`section section-padding-t90-b100 ${SectionBgColor}`}>
            <div className="container">
                <SectionTitle
                    title="Insights And Inspiration: Discover Blog"
                    subTitle="Explore our blog for valuable insights, industry trends, and inspiration to fuel your digital success."
                />
