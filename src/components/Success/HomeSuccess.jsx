                    ...
                    <div className="offset-lg-1 col-lg-5" data-aos="fade-up" data-aos-delay="300">
                        <div className="success-content mt-lg-0 mt-md-50 mt-sm-50 mt-40">
                            <SectionTitleTwo 
                                ...
                                title="Software Development, Web design, Marketing &amp; SEO solutions that get results"
                            />
                            ...
                            <div className="progress-bar--one">
                                ...
                                <div className="progress-charts ">
                                    ...
                                    <div className="single-progress">
                                        <ProgressBar data-aos="fade-right" data-aos-delay="100" data-aos-duration="450" className="gradient-4" now="87" label={<span>91%</span>} />
                                    </div>
                                </div>
                                ...
                                <div className="progress-charts ">
                                    ...
                                    <div className="single-progress">
                                        <ProgressBar data-aos="fade-right" data-aos-delay="100" data-aos-duration="450" className="gradient-3" now="90" label={<span>93%</span>} />
                                    </div>
                                </div>
